...
export class ZoomPanelService {
    ...
    zoomIn() {
        ...
        this._animationToTarget(Math.min(400, this._model.current.value + 25), 1);
    }
    ...
    zoomOut() {
        ...
        this._animationToTarget(Math.max(10, this._model.current.value - 25), -1);
    }
