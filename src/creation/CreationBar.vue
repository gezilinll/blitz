        ...
        >
            <span class="function-item">
                <svg
                    ...
                    role="presentation"
                    focusable="false"
                    :color="model.selected.value === 'brush' ? 'blue' : 'black'"
                >
                    <path
                        xmlns="http://www.w3.org/2000/svg"
                        stroke-width="2"
...
import usePresenter from './CreationBarPresenter';
...
./CreationPresenter ./CreationBarPresenter
